...
def cache_hard_regions_for_split(
    ...
    configured_small_area_ratio = float(small_area_ratio)
    expected_metadata = hard_region_cache_metadata(
        detection_metadata=detection_metadata,
        small_area_ratio=configured_small_area_ratio,
        small_area_percentile=small_area_percentile,
        match_iou=match_iou,
    ...
    for index, image_path in enumerate(images, start=1):
        ...
        if not overwrite and hard_region_cache_is_current(out_path, expected_metadata):
            continue
        ...
        hard.metadata = expected_metadata
