...
class EnvConfig:
    ...
    seed_topk: int = 4
    seed_nms_radius: int = 2
    seed_min_score: float = 0.02
    residual_objectness_weight: float = 0.5
    residual_proposal_weight: float = 1.0
    residual_small_weight: float = 0.5
    residual_high_conf_penalty: float = 1.25
    residual_previous_penalty: float = 1.0
    residual_history_penalty: float = 0.25
    roi_prefilter_high_conf_penalty: float = 1.0
    roi_prefilter_overlap_threshold: float = 0.35
    use_gpu_box_ops: bool = True
    gpu_box_device: str = "cuda"
    use_simplified_reward: bool = True
    target_reward: float = 0.75
    hard_coverage_progress_reward: float = 0.5
    empty_hard_penalty: float = 1.0
    repeated_hard_penalty: float = 0.5
    ...
    detected_overlap_count_norm: float = 3.0
